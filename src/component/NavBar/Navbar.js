...
const Navbar = () => {
  return (
    <>
      <div className="">
        <nav class="flex items-center justify-between flex-wrap bg-white p-6 pb-1 lg:pb-6 fixed z-20 w-full shadow-sm shadow-gray-200">
          <div class="flex items-center flex-shrink-0 text-teal-500 mr-6">
            ...
            <div class="font-semibold text-2xl tracking-tight ml-3 lg:ml-[6rem] lg:mr-[2rem] ">
              <span className="text-[#FFA500]">Little</span>{" "}
